...
func resetProcessMetricsForTest() {
	...
	processMetrics.connectProxyH2TargetRefs = make(map[string]int)
	...
	processMetrics.connectProxySetupLatency = make(map[connectProxyMetricKey]connectProxySetupHistogram)
	processMetrics.connectProxyH2PingFailures = make(map[string]*atomic.Uint64)
